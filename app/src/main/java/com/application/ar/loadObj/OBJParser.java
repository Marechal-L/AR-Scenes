...
public class OBJParser {
	...
	public TDModel parseOBJ(String fileName) {
		...
		try { //try to open file
			reader = new BufferedReader(new InputStreamReader(context.getAssets().open(fileName)));//new InputStreamReader(new FileInputStream(fileName)));
		} 		catch(IOException e){
			Log.v("obj",e.getMessage());
		}
		...
		t.buildVertexBuffer();
		Log.v("obj",fileName+" loaded");
		return t;
	}

	public TDModel parseOBJ(byte[] obj) {
		BufferedReader reader=null;
		String line = null;
		Material m=null;

		//try to open file
		reader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(obj)));//new InputStreamReader(context.getAssets().open(fileName)));//new InputStreamReader(new FileInputStream(fileName)));
