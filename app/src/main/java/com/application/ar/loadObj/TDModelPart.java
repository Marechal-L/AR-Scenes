...
public class TDModelPart {
	...
	public TDModelPart(TDModelPart o)
	{
		faces = new Vector<>();
		for(short face : o.faces)
		{
			faces.add(face);
		}

		normalBuffer = o.normalBuffer.duplicate();//FloatBuffer.wrap(o.normalBuffer.array());
		faceBuffer = o.faceBuffer.duplicate();//ShortBuffer.wrap(o.faceBuffer.array());
	}
